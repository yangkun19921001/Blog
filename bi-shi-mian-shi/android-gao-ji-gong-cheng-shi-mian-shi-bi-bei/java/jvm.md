...
* [一、运行时数据区域](jvm.md#一运行时数据区域)
  * [程序计数器](jvm.md#程序计数器)
  * [Java 虚拟机栈](jvm.md#java-虚拟机栈)
  * [本地方法栈](jvm.md#本地方法栈)
  * [堆](jvm.md#堆)
  * [方法区](jvm.md#方法区)
  * [运行时常量池](jvm.md#运行时常量池)
  * [直接内存](jvm.md#直接内存)
* [二、垃圾收集](jvm.md#二垃圾收集)
  * [判断一个对象是否可被回收](jvm.md#判断一个对象是否可被回收)
  * [引用类型](jvm.md#引用类型)
  * [垃圾收集算法](jvm.md#垃圾收集算法)
  * [垃圾收集器](jvm.md#垃圾收集器)
* [三、内存分配与回收策略](jvm.md#三内存分配与回收策略)
  * [Minor GC 和 Full GC](jvm.md#minor-gc-和-full-gc)
  * [内存分配策略](jvm.md#内存分配策略)
  * [Full GC 的触发条件](jvm.md#full-gc-的触发条件)
* [四、类加载机制](jvm.md#四类加载机制)
  * [类的生命周期](jvm.md#类的生命周期)
  * [类加载过程](jvm.md#类加载过程)
  * [类初始化时机](jvm.md#类初始化时机)
  * [类与类加载器](jvm.md#类与类加载器)
  * [类加载器分类](jvm.md#类加载器分类)
  * [双亲委派模型](jvm.md#双亲委派模型)
  * [自定义类加载器实现](jvm.md#自定义类加载器实现)
* [参考资料](jvm.md#参考资料)
