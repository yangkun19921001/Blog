...
- [面试官问我：“泛型擦除是什么，会带来什么问题？”](https://juejin.im/post/5e61fb10e51d4526d6406cb0?utm_source=gold_browser_extension)
...
- [Java中的String长度最大是多少](https://mp.weixin.qq.com/s/I16BlY9cJF-JZZReAjuRqg)



#十三、为什么使用 Long 时，大家推荐多使用 valueOf 方法，少使用 parseLong 方法

答：因为 Long 本身有缓存机制，缓存了 -128 到 127 范围内的 Long，valueOf 方法会从缓存中去拿值，如果命中缓存，会减少资源的开销，parseLong 方法就没有这个机制。



# 十四、如何解决 String 乱码的问题
